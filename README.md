...
### Install the module via SMF Admin Panel:
...
1. In the Admin Panel, go to **Configuration → Modification Settings → All in One Accessibility®**.
2. Open **All in One Accessibility® Settings** to configure the package.
3. Once settings are saved, the accessibility widget will automatically appear on your site.
...
## Live Demo
https://smfcms.skynettechnologies.us/
